...
export const metadata: Metadata = {
  title: 'Contact',
  description:
    'Tell us about your project. We reply within two business days — no sales calls, no pressure.',
};
  ...
  return (
    <>
      <PageHeader
        eyebrow="Contact"
        title="Let's talk"
        description="Tell us about your company and what you're trying to achieve. We read every message and reply within two business days."
      />
          ...
          <div className="flex flex-col gap-8">
            ...
            <Reveal delay={0.2}>
              <div className="flex flex-col gap-4 rounded-2xl border border-accent bg-accent p-6 text-accent-foreground">
                ...
                >
                  <a
                    href="https://calendly.com/northbeam/intro"
                    target="_blank"
        ...
        <Container className="py-12">
          <Reveal>
            <div className="relative aspect-[16/9] overflow-hidden rounded-2xl border border-border sm:aspect-[21/9]">
              <iframe
                title="Northbeam studio location"
                src="https://www.openstreetmap.org/export/embed.html?bbox=-122.4017%2C37.7857%2C-122.3917%2C37.7957&layer=mapnik&marker=37.7907%2C-122.3967"
                className="h-full w-full grayscale dark:invert dark:hue-rotate-180"
                loading="lazy"
