...
export const testimonials: Testimonial[] = [
  {
    quote:
      'Northbeam is the rare studio that thinks like a partner, not a vendor. They challenged our assumptions and built something better than we knew to ask for.',
    author: 'Marcus Webb',
    role: 'CEO',
    company: 'Lumen',
    avatar:
  ...
  {
    quote:
      'We\'ve worked with five agencies over the years. Northbeam is the only one we\'d hire again without a second thought.',
    author: 'Aisha Patel',
    role: 'VP Product',
    company: 'Harbor',
    avatar:
